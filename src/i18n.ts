...
const resources = {
    en: {
        translation: {
            ...
            "weeklyKpiWebHint": "Done or need-check — counts when completion date is set.",
            "weeklyKpiShieldHint": "Requires completion date column.",
            "weeklyKpiRegHint": "Requires Ngày Reg GMC column.",
            "week": "Week",
            "count": "Count",
            "autoSyncing": "Auto syncing...",
            "dashboardSubTitle": "KPI = done or need-check · must have completion date · one row per domain.",
            "webKpiCompleted": "Web KPI",
            "webKpiCompletedHint": "Done + need check (with date)",
            "webKpiCheckHint": "With completion date → counts as KPI",
    ...
    vi: {
        translation: {
            ...
            "weeklyKpiWebHint": "Đã HT hoặc cần check — miễn có ngày hoàn thành.",
            ...
            "dashboardSubTitle": "KPI = đã HT hoặc cần check · phải có ngày hoàn thành · 1 domain 1 dòng.",
            "webKpiCompleted": "KPI Web",
            "webKpiCompletedHint": "HT + cần check (có ngày)",
            "webKpiCheckHint": "Có ngày HT → tính KPI",
